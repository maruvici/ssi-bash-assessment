...
# MEMORY CHECK TESTS
@test "Handles MemUse < WarnThresh Case" {
    run memory_check.sh -c 100 -w 99 -e mvtevangelista0820@gmail.com
    assert_equal "$status" 0
}

@test "Handles CritThresh > MemUse >= WarnThresh Case" {
    run memory_check.sh -c 100 -w 0 -e mvtevangelista0820@gmail.com
    assert_equal "$status" 1
}

@test "Handles MemUse >= CritThresh Case" {
    run memory_check.sh -c 1 -w 0 -e mvtevangelista0820@gmail.com
